...
const ITEMS = [
  ...
  ['MV-MEDI-4E',      'MAXVAC Medi 4e',          'purifier',    11112,        true,    null],
  ['MV-MEDI-8',       'MAXVAC Medi 8',           'purifier',    35625,        true,    null],
  ['MV-MEDI-10',      'MAXVAC Medi 10',          'purifier',   120625,        true,    null],
  ['MV-MEDI-4E-F',    'MAXVAC Medi 4e filter',   'filter',       5560,        false,   12],
  ['MV-MEDI-4E-L',    'MAXVAC Medi 4e UV-C lamp','filter',       1183,        false,   12],
  ['MV-MEDI-8-F',     'MAXVAC Medi 8 filter pack','filter',     12270,        false,   12],
  ['MV-MEDI-8-L',     'MAXVAC Medi 8 UV-C lamps','filter',       1983,        false,   12]
];
